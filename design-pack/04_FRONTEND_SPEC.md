...
> **Read `BOARD_CORRECTIONS.md` first.** This is the frozen M1 spec, written before the API
> existed. Section 4.1 describes a stats tile the route does not back and omits a field the
> route returns. The corrections file overrides this document wherever the two disagree.
